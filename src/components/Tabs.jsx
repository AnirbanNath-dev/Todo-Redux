...
function Tabs() {
  ...
  return (
    <div className='fixed w-1/4 text-lg bg-[rgba(0,0,0,0.7)] text-slate-100 h-12 bottom-5 rounded-2xl py-2 px-5 flex items-center justify-between filter backdrop-blur-lg z-10 tracking-wide'>
